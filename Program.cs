                    ...
                    case "3":           //Modifica
                        {
                            ...
                            while(x < num)
                            {
                                ...
                                if (cerca == elenco[x].codice)          //Se trova un prodotto
                                {
                                    ...
                                    elenco[x].tempo = int.Parse(Console.ReadLine());
                                    ...
                                    elenco[x].prezzo = decimal.Parse(Console.ReadLine());
                    ...
                    case "4":           //Elimina
                        {
                            ...
                            while (x < num)
                            {
                                ...
                                if (cerca == elenco[x].codice)          //Quando trova la traccia la setta a default
                                {
                                    elenco[x] = default(Canzone);
